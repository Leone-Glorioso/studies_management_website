<a id="readme-top"></a>
# Σύστημα Διαχείρισης Σπουδών (My Studies Management System)
<details>
  <summary>Περιεχόμενα</summary>
  <ol>
    <li><a href="#στοιχεία-ομάδας">Στοιχεία Ομάδας</a></li>  
    <li><a href="#εισαγωγή">Εισαγωγή</a></li>  
    <li><a href="#περιγραφή-εργασίας">Περιγραφή Εργασίας</a></li>
    <li><a href="#γενικά">Γενικά</a></li>
    <li><a href="#παραδοχές">Παραδοχές</a></li>
    <li><a href="#δοκιμαστικοί-κωδικοί">Δοκιμαστικοί Κωδικοί/a></li>
  </ol>
</details>

## Στοιχεία ομάδας:
* **Ονοματεπώνυμο:** Λεοντιάδης Κωνσταντίνος	 [Leone-Glorioso](https://github.com/sdi2100127)
* **Ονοματεπώνυμο:** Νεφέλη Οικονόμου		       [sdi2100127](https://github.com/Leone-Glorioso)

<p align="right">(<a href="#readme-top">Πίσω Στην Κορυφή</a>)</p>

## Εισαγωγή
Το site αυτό δημιουργήθηκε στα πλαίσια του μαθήματος της Επικοινωνίας Ανθρώπου-Μηχανής και περιέχει το frontend της ιστοσελίδας που συνδέεται και λαμβάνει/αποθηκεύει τα δεδομένα του σε μια βάση δεδομένων τύπου firebase.
